// FluxCapacitorCPUMeter.cpp : Defines the entry point for the application.
//
#include "stdafx.h"
...
#include "FluxCapacitorCPUMeter.h"

// Defines
#define MAX_LOADSTRING 100

#define WMUSER_SERIAL		(WM_USER + 1)
...
int			 serialFD        = -1;			// Serial port file descriptor, or -1 if not opened yet
int			 serialOpenRetry =  1;			// True to try to open the serial port if we failed to open it the last time
	...
	HINSTANCE		 hInstance )
{
	...
	wcex.hIcon		= LoadIcon(hInstance, MAKEINTRESOURCE(IDI_FLUXCAPACITORCPUMETER));
	wcex.hCursor		= LoadCursor(NULL, IDC_ARROW);
	wcex.hbrBackground	= (HBRUSH)(COLOR_WINDOW+1);
	wcex.lpszMenuName	= MAKEINTRESOURCE(IDC_FLUXCAPACITORCPUMETER);
